...
@CrewBase
class SearchSummarizeCrew():
    """SearchSummarizeCrew crew"""
    ...
    def searcher_task(self) -> Task:
        return Task(
            config=self.tasks_config['searcher_task'], # type: ignore[index]
        )
    ...
    def summarizer_task(self) -> Task:
        return Task(
            ...
            context=[self.searcher_task()]
        )

    @crew
    def crew(self) -> Crew:
        """Creates the SearchSummarizeCrew crew"""
